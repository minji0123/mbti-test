export const QuestionData = [
    {
      ...
      },
      {
        ...
        answera:
          "'병원에 가보는건 어때?' 해결책을 함께 생각하며 정보들은 같이 찾아본다.",
      ...
      },
      {
        ...
        answera:
          "'사람들한테 자랑해야지..!!'하며 인스타를 만들어서 사진도 공유하고 소통도 한다.",
      ...
      },
      {
        ...
        answera:
          "'우리 고양이 몸무게는 5키로니까 하루세번 몇시에 이만큼 씩 줘야지' 계획을 세운다. ",
...

      {
        ...
        answera: "시설이 중요하지!! 좋은 시설의 대형 병원",
        answerb: "사람이 중요하지!! 원장님의 성격이 좋은 동네 병원",
        type: "TF",
      },
 
      {
        ...
        answera:
          "사료를 조금씩 급여해서 테스트 해보고 다 잘먹는다면 날짜에 맞춰서 질리지 않도록 바꿔가며  급여한다.",
